...
(let ((class '((class color) (min-colors 89)))
      ...
      (volatile-highlight-supersize '(:underline nil :foreground "white" :background "#9E3699")) ; flash-region
  ...
  (custom-theme-set-faces
   ...
   `(custom-face-tag ((,class (:family "Sans Serif" :weight bold))))
   `(custom-group-tag ((,class (:weight bold :foreground "blue1"))))
   `(custom-group-tag-1 ((,class (:family "Sans Serif" :weight bold :foreground "red1"))))
   ...
   `(custom-variable-tag ((,class (:family "Sans Serif" :weight bold :foreground "blue1"))))
   ...
   `(font-latex-sectioning-1-face ((,class (:family "Sans Serif" :weight bold :foreground "cornflower blue"))))
   ...
   `(info-file ((,class (:family "Sans Serif" :weight bold :box (:line-width 1 :color "#0000CC") :foreground "cornflower blue" :background "LightSteelBlue1"))))
   ...
   `(magit-section-title ((,class (:family "Sans Serif" :weight bold :foreground "cornflower blue" :inherit nil))))
   ...
   `(mc/cursor-bar-face ((,class (:foreground "#1664C4" :background "#1664C4"))))
   ...
   `(org-headline-done ((,class (:weight normal :foreground "#ADADAD"))))
